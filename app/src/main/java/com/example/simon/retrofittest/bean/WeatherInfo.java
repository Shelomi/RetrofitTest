package com.example.simon.retrofittest.bean;
...
public class WeatherInfo {
    ...
    public static class Result {
        ...
        public static class Future {
            ...
            public WeatherIdX getWeather_id() {
                return weather_id;
            }

            public void setWeather_id(WeatherIdX weather_id) {
                this.weather_id = weather_id;
            }
            ...
            public static class WeatherIdX {
                /**
                 * fa : 00
                 * fb : 01
                 */
